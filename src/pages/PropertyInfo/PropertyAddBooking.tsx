...
export default function PropertyAddBooking() {
    ...
    const fetchApartments = async () => {
      try {
        ...
        const response = await callApi({
          url: `/properties/${id}/available-apartments/`,
          method: "GET",
        });
  ...
  // Search for guests when dialog opens or query changes
  useEffect(() => {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      <Appbar appBarTitle={`${apartments[0]?.property_assigned_name} - ${apartments[0]?.property_address}: Create New Booking`} />
      <Box
        component="main"
        sx={{
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12} md={6}>
                      ...
                      <Typography variant="subtitle1" gutterBottom>
                        ...
                        <Chip
                          label={
                            bookingDetails.apartment.inService === false
                              ? "Available"
                              : "Occupied"
                          }
                          color={
                    ...
                    {guestData.user.first_name && (
                      <Grid item xs={12}>
                        ...
                        <Typography variant="subtitle1">
                          <strong>Phone:</strong> {guestData.user.phone}
                        </Typography>
                        <Typography variant="subtitle1">
                          <strong>Email:</strong> {guestData.user.email}
                        </Typography>
                      </Grid>
                    )}
                  </Grid>
