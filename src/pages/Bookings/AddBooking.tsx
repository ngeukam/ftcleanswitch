...
export default function AddBooking() {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      <Appbar appBarTitle="Create New Booking" />
      <Box
        component="main"
        sx={{
                              ...
                              >
                                <Box>
                                  ...
                                  >
                                    ...
                                    {renderApartmentType(apartment.apartmentType)}{" "}
                                  ...
                                  >
                                    {apartment.property_assigned_name}-{apartment.property_address}
                                  </Typography>
                                </Box>
                                <Typography>
                                  {apartment.currency}
